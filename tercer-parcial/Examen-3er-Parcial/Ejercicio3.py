...
X_no_norm = np.array([2016,2017,2018,2019,2020,2021,2022,2023,2024])
...
#Clasificación 
x_test_clas = np.array(input("Introduce el valor de x para clasificar: "))
y_test_clas = np.array(input("Introduce el valor de y para clasificar: "))
...
X_normalizada = normalizacion(np.array([X_test]))
